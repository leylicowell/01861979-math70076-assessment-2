...
- elpd_diff: Difference in expected log pointwise predictive density (ELPD) between models
- se_diff: Standard error of the difference in ELPD
- elpd_loo: ELPD for leave-one-out cross-validation
- se_elpd_loo: Standard error of the ELPD for leave-one-out cross-validation
